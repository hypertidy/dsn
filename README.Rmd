...
`vrtcon()` is for a [VRT connection](https://gdal.org/drivers/raster/vrt.html#vrt-connection-string) string, a compact and dependency free sytax for augmenting GDAL data source names, there are new features coming for that in GDAL 3.7. 
