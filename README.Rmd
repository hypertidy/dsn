...
- prepending '/viscurl/' to an online data source url for [GDAL's Virtual File System](https://gdal.org/user/virtual_file_systems.html)
- prepending a driver declaration to a data source, e.g. "HDF5:/my/files/data.h5" or "NETCDF:C:/temp/nc/afile.nc"
